...
public class Approval {
	...
	@JoinColumn(name = "solver_Id", referencedColumnName = "member_id")
//	@Column(name = "solver_id")
	private Member solverId;
	...
	public Approval(String approvalId, String description, String releaseVersion, String testResult, Member solverId,
	...
	public Member getSolverId() {
		return solverId;
	}

	public void setSolverId(Member solverId) {
		this.solverId = solverId;
	}
